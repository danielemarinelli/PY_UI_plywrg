...
def add_product_to_cart(page):
    ...
    home_page = HomePage(page)
    search_results_page=ProductSearchPage(page)
    ...
    expect(search_results_page.is_product_present(product_name)).to_be_visible(timeout=3000)
